export const t = {
  ...
  slotCostumeHeadLow: "Fantasia (inferior)",
  slotCostumeGarment: "Fantasia (manto)",
  slotShadowArmor: "Sombra (armadura)",
  slotShadowWeapon: "Sombra (arma)",
  slotShadowShield: "Sombra (escudo)",
  slotShadowShoes: "Sombra (calçado)",
  slotShadowAccLeft: "Sombra (acess. esq.)",
  slotShadowAccRight: "Sombra (acess. dir.)",
  slotOther: "Outro",
