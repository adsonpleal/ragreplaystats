...
// skill.json, generated by tools/build-db.mjs). Monster names/HP/level come
// from the sibling project ragassets' mobs.json (monster.json, generated by
// tools/build-monsters.mjs) — ragassets derives those from the client's navi
// data and localizes them. On first lookup we fetch each kind's file, parse it
